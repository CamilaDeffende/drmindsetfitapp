...
const LazyAchievementsPage = React.lazy(() =>
  import("@/pages/gamification/AchievementsPage").then((m) => ({ default: m.AchievementsPage }))
);
const LazyConflictsPage = React.lazy(() =>
  import("@/pages/offline/ConflictsPage").then((m) => ({ default: m.ConflictsPage }))
);
...
const LazyFitnessSuiteDemo = React.lazy(() =>
  import("./features/fitness-suite").then((m) => ({ default: m.FitnessSuiteDemo }))
);
