          ...
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
              ...
              <div className="space-y-4 pt-6 border-t">
                <h3 className="font-semibold text-lg">Perfil Físico e Esportivo</h3>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>Nível de Treino</FormLabel>
                      <Select onValueChange={field.onChange} defaultValue={field.value}>
                        <FormControl>
                          <SelectTrigger>
                            <SelectValue />
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel>Frequência Semanal (dias)</FormLabel>
                        <FormControl>
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel>Duração do Treino (min)</FormLabel>
                        <FormControl>
              ...
              <div className="flex justify-end pt-6">
                <Button type="submit" size="lg" className="bg-gradient-to-r from-[#1E6BFF] to-[#00B7FF] hover:from-[#1E6BFF] hover:to-[#00B7FF]">
                  Próxima Etapa
