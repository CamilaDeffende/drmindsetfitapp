                    ...
                    {objetivos.map((item) => {
                      ...
                      return (
                        <button
                          ...
                          className={[
                            "relative w-full overflow-hidden rounded-[22px] border px-4 py-4 text-left transition-all",
                            active
                              ? "border-emerald-400/40 bg-white/[0.04] shadow-[0_0_24px_rgba(34,197,94,0.10)]"
                        ...
                        >
                          ...
                          <div className="relative flex items-start gap-3">
                            ...
                            <div className="min-w-0 flex-1">
                              ...
                              <div className="mt-1 text-[13px] leading-5 text-white/50">
                                {item.desc}
                              </div>

                              {active && (
                                <div className="mt-3 inline-flex items-center rounded-full border border-emerald-400/20 bg-emerald-400/10 px-2.5 py-1 text-[11px] text-emerald-300">
