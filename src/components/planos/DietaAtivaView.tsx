            ...
            <div className="p-4 rounded-2xl bg-black/60 border border-white/10">
              <div className="flex items-start justify-between gap-3">
                <div>
                  ...
                  <div className="text-xs text-gray-400 mt-1">
                    Base: <span className="text-white/90">{eqOpen.foodName}</span> · <span className="text-white/90">{mfRound(eqOpen.kcal)} kcal</span>
                  </div>
                </div>
                    ...
                    {opts.map((o: any, i: number) => {
                      ...
                      return (
                        <div key={i} className="p-3 rounded-xl bg-black/30 border border-white/10">
                          ...
                          <div className="text-xs text-gray-400 mt-1">
                            Porção equivalente: <span className="text-white/90">{mfRound(portion)} {o.unit}</span> · ref {o.kcal100} kcal/100{o.unit}
                          </div>
