...
export default function Assinatura() {
  ...
  const plans: Plan[] = useMemo(
    () => [
      ...
      },
      {
        ...
        title: "Anual",
        price: "R$ 597,90",
        note: "12 meses de acesso • Plano anual",
      },
    ],
    []
  );
  ...
  const goToCheckout = (planId: "mensal" | "anual") => {
    navigate(`/checkout?plan=${encodeURIComponent(planId)}`, { replace: true });
  };
        ...
        <div className="mt-6 rounded-3xl border border-white/10 bg-white/[0.04] p-5 shadow-[0_20px_60px_-30px_rgba(0,149,255,0.35)]">
          ...
          <div className="mt-4">
            ...
            <div className="mt-2 text-center text-[11px] text-white/55">
              Você ainda poderá assinar depois no app.
            </div>
          </div>
        </div>
