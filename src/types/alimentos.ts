...
export const ALIMENTOS_DATABASE: AlimentoDatabase[] = [
  ...
  },
  {
    ...
    categoria: 'carboidrato',
    porcaoPadrao: 60,
    macrosPor100g: { calorias: 247, proteinas: 13, carboidratos: 41, gorduras: 3.4 },
    substituicoes: ['aveia', 'cuscuz', 'tapioca', 'arroz-integral'],
    vegano: true,
    vegetariano: true,
    semLactose: true,
    semGluten: false,
  ...
  },
  {
    ...
    categoria: 'carboidrato',
    porcaoPadrao: 70,
    macrosPor100g: { calorias: 358, proteinas: 0.2, carboidratos: 88, gorduras: 0.1 },
    substituicoes: ['cuscuz', 'pao-integral', 'aveia'],
    vegano: true,
    vegetariano: true,
    semLactose: true,
    semGluten: true,
  ...
  },
  {
    ...
    categoria: 'carboidrato',
    porcaoPadrao: 120,
    macrosPor100g: { calorias: 112, proteinas: 3.8, carboidratos: 23, gorduras: 0.2 },
    substituicoes: ['tapioca', 'pao-integral', 'arroz-integral'],
    vegano: true,
    vegetariano: true,
    semLactose: true,
    semGluten: false,
  ...
  },
  {
    ...
    categoria: 'proteina',
    porcaoPadrao: 150,
    macrosPor100g: { calorias: 176, proteinas: 26, carboidratos: 0, gorduras: 7.5 },
    substituicoes: ['frango-peito', 'peru', 'peixe-tilapia'],
    vegano: false,
    vegetariano: false,
    semLactose: true,
    semGluten: true,
  ...
  },
  {
    ...
    categoria: 'proteina',
    porcaoPadrao: 120,
    macrosPor100g: { calorias: 208, proteinas: 25, carboidratos: 0, gorduras: 11 },
    substituicoes: ['atum', 'peixe-tilapia', 'peixe-salmao'],
    vegano: false,
    vegetariano: false,
    semLactose: true,
    semGluten: true,
  ...
  },
  {
    ...
    categoria: 'proteina',
    porcaoPadrao: 140,
    macrosPor100g: { calorias: 99, proteinas: 24, carboidratos: 0.2, gorduras: 0.3 },
    substituicoes: ['peixe-tilapia', 'atum', 'frango-peito'],
    vegano: false,
    vegetariano: false,
    semLactose: true,
    semGluten: true,
  ...
  },
  {
    ...
    categoria: 'proteina-vegetal',
    porcaoPadrao: 120,
    macrosPor100g: { calorias: 122, proteinas: 11, carboidratos: 10, gorduras: 5 },
    substituicoes: ['tofu', 'tempeh', 'lentilha', 'grao-de-bico'],
    vegano: true,
    vegetariano: true,
    semLactose: true,
    semGluten: true,
  ...
  },
  {
    ...
    categoria: 'legume',
    porcaoPadrao: 100,
    macrosPor100g: { calorias: 18, proteinas: 0.9, carboidratos: 3.9, gorduras: 0.2 },
    substituicoes: ['pepino', 'abobrinha', 'cenoura'],
    vegano: true,
    vegetariano: true,
    semLactose: true,
    semGluten: true,
  ...
  },
  {
    ...
    categoria: 'legume',
    porcaoPadrao: 100,
    macrosPor100g: { calorias: 15, proteinas: 0.7, carboidratos: 3.6, gorduras: 0.1 },
    substituicoes: ['tomate', 'abobrinha', 'brocolis'],
    vegano: true,
    vegetariano: true,
    semLactose: true,
    semGluten: true,
  ...
  },
  {
    ...
    categoria: 'legume',
    porcaoPadrao: 100,
    macrosPor100g: { calorias: 43, proteinas: 1.6, carboidratos: 10, gorduras: 0.2 },
    substituicoes: ['cenoura', 'abobrinha', 'tomate'],
    vegano: true,
    vegetariano: true,
    semLactose: true,
    semGluten: true,
  ...
  },
  {
    ...
    categoria: 'legume',
    porcaoPadrao: 100,
    macrosPor100g: { calorias: 20, proteinas: 2.2, carboidratos: 3.9, gorduras: 0.1 },
    substituicoes: ['brocolis', 'abobrinha', 'vagem'],
    vegano: true,
    vegetariano: true,
    semLactose: true,
    semGluten: true,
  ...
  },
  {
    ...
    categoria: 'fruta',
    porcaoPadrao: 140,
    macrosPor100g: { calorias: 57, proteinas: 0.4, carboidratos: 15, gorduras: 0.1 },
    substituicoes: ['maca', 'kiwi', 'morango'],
    vegano: true,
    vegetariano: true,
    semLactose: true,
    semGluten: true,
  ...
  },
  {
    ...
    categoria: 'fruta',
    porcaoPadrao: 120,
    macrosPor100g: { calorias: 61, proteinas: 1.1, carboidratos: 15, gorduras: 0.5 },
    substituicoes: ['morango', 'pera', 'maca'],
    vegano: true,
    vegetariano: true,
    semLactose: true,
    semGluten: true,
  ...
  },
  {
    ...
    categoria: 'fruta',
    porcaoPadrao: 120,
    macrosPor100g: { calorias: 69, proteinas: 0.7, carboidratos: 18, gorduras: 0.2 },
    substituicoes: ['maca', 'pera', 'morango'],
    vegano: true,
    vegetariano: true,
    semLactose: true,
    semGluten: true,
  ...
  {
    id: 'iogurte-zero-lactose',
    nome: 'Iogurte Zero Lactose',
    categoria: 'laticinio',
    porcaoPadrao: 160,
    macrosPor100g: { calorias: 58, proteinas: 5.5, carboidratos: 6, gorduras: 1.5 },
    substituicoes: ['iogurte-grego', 'queijo-cottage-zero-lactose', 'tofu'],
    vegano: false,
    vegetariano: true,
    semLactose: true,
    semGluten: true,
  ...
  {
    id: 'queijo-cottage-zero-lactose',
    nome: 'Queijo Cottage Zero Lactose',
    categoria: 'laticinio',
    porcaoPadrao: 100,
    macrosPor100g: { calorias: 98, proteinas: 11, carboidratos: 3.4, gorduras: 4.3 },
    substituicoes: ['queijo-cottage', 'iogurte-zero-lactose', 'tofu'],
    vegano: false,
    vegetariano: true,
    semLactose: true,
    semGluten: true,
  ...
  },
  {
    ...
    categoria: 'gordura',
    porcaoPadrao: 20,
    macrosPor100g: { calorias: 588, proteinas: 25, carboidratos: 20, gorduras: 50 },
    substituicoes: ['castanhas', 'abacate'],
    vegano: true,
    vegetariano: true,
    semLactose: true,
    semGluten: true,
