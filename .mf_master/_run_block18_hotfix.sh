...
echo "============================================================"
echo "✅ BLOCO 18 HOTFIX (RUNNER) | mf_doctor macOS-safe (sem mapfile)"
echo "============================================================"
...
echo "==> Recriar .mf_master/mf_doctor.sh (sem mapfile)"
...
echo "==> Rodar mf_doctor (fixado)"
.mf_master/mf_doctor.sh

echo
echo "==> COMMIT + TAG"
git add .gitignore .mf_master/mf_doctor.sh .mf_master/_run_block18_hotfix.sh || true
git commit -m "chore(block18): mf_doctor macos-safe (remove mapfile) (build green)" || echo "ℹ️ Nada para commitar."
git push origin main

TAG="freeze-block18-doctor-guardrails-v1.0.2"
git tag -f "$TAG"
git push origin -f "$TAG"

echo
echo "============================================================"
echo "✅ HOTFIX OK | BUILD VERDE | TAG $TAG"
echo "============================================================"
