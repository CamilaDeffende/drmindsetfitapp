#!/usr/bin/env node
/**
 * BLOCO 6B FIX3 — UI completa + equivalências
 * Robusto para: "return (" OU "return <div ...>"
...
// achar return de qualquer forma
const mReturn = comp.match(/\breturn\b/);
let returnPos = mReturn ? comp.indexOf(mReturn[0]) : -1;
...
// injeta calc + return antes do '}' final
...
write(FILE, s);
console.log("✅ FIX3 aplicado em:", FILE);
